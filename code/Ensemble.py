...
def loadData(data):
	...
	if Globals.predict == 't': # two-way interaction
		train = np.append(train,[np.multuply(PSVD_A[known],RSVD_A[known])],axis=0)
		train = np.append(train,[np.multuply(PSVD_A[known],RSVD2_A[known])],axis=0)
		train = np.append(train,[np.multuply(PSVD_A[known],KRR_A[known])],axis=0)
		train = np.append(train,[np.multuply(PSVD_A[known],LM_A[known])],axis=0)
		train = np.append(train,[np.multuply(RSVD_A[known],RSVD2_A[known])],axis=0)
		train = np.append(train,[np.multuply(RSVD_A[known],KRR_A[known])],axis=0)
		train = np.append(train,[np.multuply(RSVD_A[known],LM_A[known])],axis=0)
		train = np.append(train,[np.multuply(RSVD2_A[known],KRR_A[known])],axis=0)
		train = np.append(train,[np.multuply(RSVD2_A[known],LM_A[known])],axis=0)
	train = train.T
